...
def main():
    ...
    onnx_file_path = '/media/zw/DL/ly/workspace/project04/yolov3-multigpu/weights/export.onnx'
    engine_file_path = "../../weights/yolov3.trt"
    ...
    input_resolution_yolov3_HW = (352, 608)
