...
hyp = {'giou': 3.54,  # giou loss gain
       ...
       'lr0': 9E-5,#0.00579,  # initial learning rate (SGD=1E-3, Adam=9E-5)
...
def train():
    ...
    if weights.endswith('.pt'):  # pytorch format
        ...
        start_epoch = chkpt['epoch'] + 1 if opt.resume else 1
        del chkpt
    ...
    #scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[100], gamma=0.1)  # gradual fall to 0.1*lr0
...
# python --epochs 50 --batch 4 -accum 2 --cfg 'config/yolov3-custom.cfg' --data 'config/custom.data' --multi --img-size 608 --weights 'weights/darknet53.conv.74' --arc 'Fdefault' 
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='config/custom.data', help='*.data file path')
